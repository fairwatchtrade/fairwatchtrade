      ...
      <div className="flex flex-1 flex-col">
        ...
        <div className="flex flex-1 flex-col items-center justify-center px-11 py-12">
          <div className="w-full max-w-[320px]">
            ...
            {error && (
              <div className="mt-4 border border-[color:light-dark(rgba(160,59,51,0.42),rgba(220,80,80,0.3))] bg-[color:light-dark(rgba(160,59,51,0.07),rgba(220,80,80,0.08))] px-3 py-2 fw-functional-copy text-[var(--danger)]">
                {error}
              </div>
            )}
