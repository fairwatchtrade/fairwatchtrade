...
export async function generateViewport(): Promise<Viewport> {
  ...
  /* Daylight containment: System resolves Dark (globals.css), so the browser
     strip pins the dark color instead of following the OS. Restore the
     prefers-color-scheme media pair when Daylight reopens. */
