...
/* `flight` is the plan's only instance-specific label. It defaults to the
   original ET33/ET35/ET36 string so the CLI path and the migrated packet
   both produce byte-identical plan bytes; a new Layer 2 sale supplies its
   own through its governed descriptor. */
export async function buildLayer2Plan({ manifest, corpusSha256, rows, db, flight = "monaco-layer2-et33-et35-et36" }) {
