...
export function renderDossierHtml(vm: CollectorDossierViewModel): string {
  ...
  <div class="fwt-dossier__sheet">
    ...
    <!-- The colophon carries the canary mark and nothing else. The editorial
         manuscript and delta SHA-256 digests are kept on the view model for
         validation, manifests and evidence handling, but they are internal
         audit apparatus and must never appear in the reader-facing dossier —
         neither here nor in the PDF, which is this same string. -->
