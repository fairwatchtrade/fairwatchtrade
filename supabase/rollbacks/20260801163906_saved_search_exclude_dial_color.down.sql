...
-- (20260801155116 — dialColor branch present, no excludeDialColor). Saved
-- Searches carrying an excludeDialColor meaning then pass through the
-- watcher non-restrictively again, per the unknown-kind fall-through design.
